...
TEST_CASE("PointsCluster - centroid throws on empty cluster") {
  ...
  CHECK_THROWS_WITH(cluster.centroid(), "Cannot compute centroid of an empty PointsCluster.");
}
...
TEST_CASE("PointsCluster - firstTimestamp throws on empty cluster") {
  ...
  CHECK_THROWS_WITH(cluster.firstTimestamp(), "PointsCluster is empty, no first timestamp available.");
}
...
TEST_CASE("PointsCluster - lastTimestamp throws on empty cluster") {
  ...
  CHECK_THROWS_WITH(cluster.lastTimestamp(), "PointsCluster is empty, no last timestamp available.");
}

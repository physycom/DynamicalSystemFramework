...
//       Street s{std::make_pair(0, 1), 2.};  // Capacity of 1 agent
//       Graph graph2;
//       graph2.addStreets(s);
//       graph2.buildAdj();
...
//       Street s1{std::make_pair(0, 1), 2.};
//       Street s2{std::make_pair(1, 2), 5.};
//       Street s3{std::make_pair(0, 2), 10.};
//       Graph graph2;
...
//       Street s2{std::make_pair(1, 2), 5.};
//       Street s3{std::make_pair(0, 3), 5.};
//       Street s4{std::make_pair(3, 2), 5.};
//       Graph graph;
...
//       Street s1{std::make_pair(0, 1), 13.8888888889};
//       Street s2{std::make_pair(1, 0), 13.8888888889};
//       Graph graph2;
...
//       Street s0_1{std::make_pair(0, 1), 30., 15.};
//       Street s1_0{std::make_pair(1, 0), 30., 15.};
//       Street s1_2{std::make_pair(1, 2), 30., 15.};
//       Street s2_1{std::make_pair(2, 1), 30., 15.};
//       Graph graph2;
...
//         "an agent") {
//       TrafficLight tl{1, 4};
//       Street s1{std::make_pair(0, 1), 30., 15.};
//       Street s2{std::make_pair(1, 2), 30., 15.};
//       Street s3{std::make_pair(3, 1), 30., 15.};
//       Street s4{std::make_pair(1, 4), 30., 15.};
//       tl.setCycle(s1.nodePair(), dsm::Direction::RIGHT, {2, 0});
//       tl.setCycle(s2.nodePair(), dsm::Direction::RIGHT, {2, 0});
//       tl.setCycle(s3.nodePair(), dsm::Direction::RIGHT, {2, 2});
//       tl.setCycle(s4.nodePair(), dsm::Direction::RIGHT, {2, 2});
//       Graph graph2;
...
//         "streets") {
//       // Streets
//       Street s0_1{std::make_pair(0, 1), 30., 15., 3};
//       Street s1_0{std::make_pair(1, 0), 30., 15., 3};
//       Street s1_2{std::make_pair(1, 2), 30., 15., 3};
//       Street s2_1{std::make_pair(2, 1), 30., 15., 3};

//       Street s3_1{std::make_pair(3, 1), 30., 15.};
//       Street s1_3{std::make_pair(1, 3), 30., 15.};
//       Street s4_1{std::make_pair(4, 1), 30., 15.};
//       Street s1_4{std::make_pair(1, 4), 30., 15.};

//       Graph graph2;
//       {
//         auto tl = TrafficLight{1, 6};
//         tl.setCycle(s0_1.nodePair(), dsm::Direction::RIGHTANDSTRAIGHT, {2, 2});
//         tl.setCycle(s0_1.nodePair(), dsm::Direction::LEFT, {1, 4});
//         tl.setCycle(s2_1.nodePair(), dsm::Direction::ANY, {3, 2});
//         tl.setComplementaryCycle(s3_1.nodePair(), s2_1.nodePair());
//         tl.setComplementaryCycle(s4_1.nodePair(), s2_1.nodePair());
//         tl.setCoords({0., 0.});
...
//         tl.setCycle(s0_1.nodePair(), dsm::Direction::RIGHTANDSTRAIGHT, {2, 0});
//         tl.setCycle(s0_1.nodePair(), dsm::Direction::LEFT, {1, 2});
//         tl.setCycle(s2_1.nodePair(), dsm::Direction::ANY, {3, 0});
//         tl.setComplementaryCycle(s3_1.nodePair(), s2_1.nodePair());
//         tl.setComplementaryCycle(s4_1.nodePair(), s2_1.nodePair());
//         tl.setCoords({0., 0.});
...
//         Street s_01{std::make_pair(0, 1), length, max_speed};
//         Street s_10{std::make_pair(1, 0), length, max_speed};
//         Street s_12{std::make_pair(1, 2), length, max_speed};
//         Street s_21{std::make_pair(2, 1), length, max_speed};
//         Street s_13{std::make_pair(1, 3), length, max_speed};
//         Street s_31{std::make_pair(3, 1), length, max_speed};
//         Street s_14{std::make_pair(1, 4), length, max_speed};
//         Street s_41{std::make_pair(4, 1), length, max_speed};
//         Graph graph2;
//         graph2.addStreets(s_01, s_10, s_12, s_21, s_13, s_31, s_14, s_41);
//         graph2.buildAdj();
//         auto& tl = graph2.makeTrafficLight(1, 8, 3);
//         tl.addStreetPriority(s_01.nodePair());
//         tl.addStreetPriority(s_21.nodePair());
//         tl.setCycle(s_01.nodePair(), dsm::Direction::ANY, {4, 0});
//         tl.setCycle(s_21.nodePair(), dsm::Direction::ANY, {4, 0});
//         tl.setComplementaryCycle(s_31.nodePair(), s_21.nodePair());
//         tl.setComplementaryCycle(s_41.nodePair(), s_21.nodePair());
//         Dynamics dynamics{graph2, 69};
...
//       Street s1{std::make_pair(0, 1), 10., 10.};
//       Street s2{std::make_pair(2, 1), 10., 10.};
//       Street s3{std::make_pair(1, 0), 10., 10.};
//       Street s4{std::make_pair(1, 2), 10., 10.};
//       Graph graph2;
//       graph2.addStreets(s1, s2, s3, s4);
//       graph2.buildAdj();
...
//     Street s1{std::make_pair(0, 1), 20., 20.};
//     Street s2{std::make_pair(1, 2), 30., 15.};
//     Street s3{std::make_pair(3, 1), 30., 15.};
//     Street s4{std::make_pair(1, 4), 30., 15.};
//     Graph graph2;
...
//       auto& sOA = graph2.addEdge<Street>(std::make_pair(0, 1), 10., 10.);
//       auto& sOB = graph2.addEdge<Street>(std::make_pair(0, 2), 10., 10.);
//       auto& sOC = graph2.addEdge<Street>(std::make_pair(0, 3), 10., 10.);
//       auto& sOD = graph2.addEdge<Street>(std::make_pair(0, 4), 10., 10.);
//       auto& sAO = graph2.addEdge<Street>(std::make_pair(1, 0), 10., 10.);
//       auto& sBO = graph2.addEdge<Street>(std::make_pair(2, 0), 10., 10.);
//       auto& sCO = graph2.addEdge<Street>(std::make_pair(3, 0), 10., 10.);
//       auto& sDO = graph2.addEdge<Street>(std::make_pair(4, 0), 10., 10.);
//       graph2.buildAdj();
//       Dynamics dynamics{graph2, 69};

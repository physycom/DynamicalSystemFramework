...
int main(int argc, char* argv[]) {
  ...
  std::ofstream ofs{std::format("./stalingrado_output_notl_{:.1f}_{:.2f}.csv", SCALING_FACTOR, TIME_SCALING)};
  std::ofstream ofs_queues{std::format("./stalingrado_notl_queues_{:.1f}_{:.2f}.csv", SCALING_FACTOR, TIME_SCALING)};
